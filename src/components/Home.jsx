        ...
        <Carousel className="w-full mx-auto">
          <div className="my-28 md:my-8 py-12 flex flex-col md:flex-row-reverse items-center justify-between gap-12 ">
            ...
            <div className="md:w-1/2">
              <h1 className="text-5xl font-semibold mb-4 text-neutralDGrey md:w-3/4 leading-snug">Добро пожаловать в OmniVision! <span className="text-brandPrimary leading-snug">Платформа для вашего успеха.</span>
              </h1>
          ...
          <div className="my-28 md:my-8 py-12 flex flex-col md:flex-row-reverse items-center justify-between gap-12 ">
            ...
            {/*Главный текст */}
            <div className="md:w-1/2">
              <h1 className="text-5xl font-semibold mb-4 text-neutralDGrey md:w-3/4 leading-snug">Все инструменты для вашего маркетинга <span className="text-brandPrimary leading-snug"> в одном месте</span>
              </h1>
          ...
          <div className="my-28 md:my-8 py-12 flex flex-col md:flex-row-reverse items-center justify-between gap-12 ">
            ...
            {/*Главный текст */}
            <div className="md:w-1/2">
              <h1 className="text-5xl font-semibold mb-4 text-neutralDGrey md:w-3/4 leading-snug">Успешные кейсы <span className="text-brandPrimary leading-snug"> и довольные клиенты </span>
              </h1>
